...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:Drup4l!128@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civiuser:C1v1!881@localhost/civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  #define( 'CIVICRM_UF_BASEURL'      , 'http://drupal.compucorp.devops.local/');
  define( 'CIVICRM_UF_BASEURL'      , 'https://nogardenonedragon.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'c6a60f7f5823e421228c6734e928dd8a');
}
